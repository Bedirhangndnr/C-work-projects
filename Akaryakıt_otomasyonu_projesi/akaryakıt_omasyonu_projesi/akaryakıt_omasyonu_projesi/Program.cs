    ...
    internal class Program
    {
        ...
        MENU:
            ...
            ALTMENU:
                ...
                {
                    Console.WriteLine("1,2 seçenekleri disinda yanlis secim yaptiniz");
                    goto ALTMENU;
                }
            }
            ...
            AKARYAKITTIPI:
                ...
                {
                    Console.Clear();
                    Console.WriteLine("dizel(D):{0} YL/litre", dizel);
                    Console.WriteLine("dizel yakit icin yeni fiyat giriniz");
                ...
                {
                    Console.Clear();
                    Console.WriteLine("benzin(D):{0} YL/litre", benzin);
                    Console.WriteLine("benzin yakit icin yeni fiyat giriniz");
                    dizel = Convert.ToDouble(Console.ReadLine());
                    Console.WriteLine("Degisiklik yapilmistir");
                    Console.WriteLine("benzin(D):{0} YL/litre", benzin);
                    goto MENU;
                ...
                {
                    Console.Clear();
                    Console.WriteLine("lpg(D):{0} YL/litre", lpg);
                    Console.WriteLine("lpg yakit icin yeni fiyat giriniz");
                    dizel = Convert.ToDouble(Console.ReadLine());
                    Console.WriteLine("Degisiklik yapilmistir");
                    Console.WriteLine("lpg(D):{0} YL/litre", lpg);
                    goto MENU;
            ...
            AKARYAKITSATISI:
                ...
                if (akaryakitsatistipi == 'D' || akaryakitsatistipi == 'd')
                {
                    if (dizeltank == 0)
                    {
                        Console.WriteLine("tankta yakit kalmamistir");
                        goto MENU;
                    }
                    else
                    {
                        ...
                        {
                            Console.WriteLine("yakit tankinde {0} litre dize yakit vardir, islem yapilamadi!!!!!!!!!!!!!!", dizeltank);
                            goto MENU;
                        }
                ...
                else if (akaryakitsatistipi == 'B' || akaryakitsatistipi == 'b')
                {
                    ...
                    else
                    {
                        ...
                        {
                            Console.WriteLine("benzin yakit tankinde {0} litre dize yakit vardir, islem yapilamadi!!!!!!!!!!!!!!", benzintank);
                            goto MENU;
                        }
                ...
                else if (akaryakitsatistipi == 'L' || akaryakitsatistipi == 'l')
                {
                    ...
                    else
                    {
                        ...
                        {
                            Console.WriteLine("yakit tankinde {0} litre dize yakit vardir, islem yapilamadi!!!!!!!!!!!!!!", lpgtank);
                            goto MENU;
                        }
                ...
                {
                    Console.WriteLine("d b l disinda hatali tuslama yapilmistir");
